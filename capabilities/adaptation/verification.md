## Verification
Verification as an inference-time capability: verifiers, critics, self-verification, and step/process verification — distinct from self-correction (reflection/retry) and evaluation (benchmark methodology).
